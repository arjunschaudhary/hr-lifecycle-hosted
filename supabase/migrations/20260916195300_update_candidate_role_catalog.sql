...
begin
    ...
    v_expected_role_code := case v_applied_role
        when 'Automation Intern' then 'AUT'
        when 'Full Stack Developer Intern' then 'FSD'
        when 'Java Developer Intern' then 'JAV'
        when 'Project Manager Intern' then 'PMT'
        when 'Clinical Psychologist Intern' then 'CPS'
        when 'Psycho-Oncology Support Intern' then 'POS'
        when 'Clinical Dietitian Intern' then 'CDT'
        when 'Nutritionist Intern' then 'NUT'
        when 'HR Psyconnect Intern' then 'HPI'
        when 'HR Operations Intern' then 'HRO'
        when 'Talent Acquisition Intern' then 'TAC'
        when 'Business Development Intern' then 'BDE'
        when 'Graphic Designer Intern' then 'GDS'
        when 'Poster Designer Intern' then 'PDS'
        when 'Video Editor Intern' then 'VED'
        when 'Public Relations Intern' then 'PRL'
        when 'Social Media Manager Intern' then 'SMM'
        when 'Operations Associate Intern' then 'OPA'
        when 'UI/UX Designer Intern' then 'UIX'
        when 'Marketing Intern' then 'MKT'
        when 'Lead Generation Intern' then 'LGE'
