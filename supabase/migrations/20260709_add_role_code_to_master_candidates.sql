...
SET role_code = CASE applied_role
    WHEN 'Automation & Operations' THEN 'AOP'
    WHEN 'Brand Management & Outreach' THEN 'BMO'
    WHEN 'Business Development' THEN 'BDE'
    WHEN 'Clinical Psychologist' THEN 'CPS'
    WHEN 'Content Creation' THEN 'CON'
    WHEN 'Creative Design' THEN 'CRD'
    WHEN 'Graphic Design' THEN 'GDE'
    WHEN 'HR Psychologist' THEN 'HPS'
    WHEN 'Human Resources (HR)' THEN 'HRM'
    WHEN 'Lead Generation' THEN 'LGE'
    WHEN 'Marketing' THEN 'MKT'
    WHEN 'Media & Public Relations (PR)' THEN 'MPR'
    WHEN 'Motion Graphics' THEN 'MOG'
    WHEN 'Operations' THEN 'OPR'
    WHEN 'Project Management' THEN 'PMT'
    WHEN 'Python Automation' THEN 'PYA'
    WHEN 'Sales and Marketing' THEN 'SAM'
    WHEN 'Social Media Management' THEN 'SMM'
    WHEN 'Talent Acquisition' THEN 'TAC'
    WHEN 'Video Editing/Making' THEN 'VEM'
    WHEN 'UI/UX Design' THEN 'UIX'
    WHEN 'Full stack Developer' THEN 'FSD'
    ELSE role_code
END
